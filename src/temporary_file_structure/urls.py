...
urlpatterns = [
     ...
     # CRUD URLS
     path('create_reservation/<str:tk>/<str:pk>/',views_b_crud.createReservation, name='create_reservation'),
     path('update_reservation/<str:pk>/',views_b_crud.updateReservation,name='update_reservation'),
     ...
     path('logout', views_c_login.loginUser, name='logout'),
     ...
     path('timeslots/', views_e_lists.timeslots, name='timeslots_all'),
